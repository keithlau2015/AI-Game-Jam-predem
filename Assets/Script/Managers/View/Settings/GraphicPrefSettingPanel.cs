...
public class GraphicPrefSettingPanel : CommonPopUpPanel
{
    ...
    public override void Show()
    {
        ...
        {
            string label = LocalizationManager.singleton.GetLocalization($"SYS_WindowMode_{(int)fullScreenMode}");
        ...
        windowMode.onValueChanged.AddListener(value => {
            ...
            windowMode.captionText.text = LocalizationManager.singleton.GetLocalization($"SYS_WindowMode_{value}");
        });
        ...
        foreach (GraphicManager.FramerateType framerateType in Enum.GetValues(typeof(GraphicManager.FramerateType)))
        {
            ...
            {
                label = LocalizationManager.singleton.GetLocalization("SYS_Unlimited");
            }
        ...
        foreach (GraphicManager.AntiAliasingType type in Enum.GetValues(typeof(GraphicManager.AntiAliasingType)))
        {
            ...
            {
                label = LocalizationManager.singleton.GetLocalization("SYS_Close");
            }
        ...
        {
            string label = LocalizationManager.singleton.GetLocalization($"SYS_SQ_{(int)shadowQuality}");
            Dropdown.OptionData optionData = new Dropdown.OptionData(label);
        ...
        shadowQuality.onValueChanged.AddListener(value => {
            ...
            shadowQuality.captionText.text = LocalizationManager.singleton.GetLocalization($"SYS_SQ_{value}");
        });
    ...
    public override void Hide()
    {
        if (!GraphicManager.singleton.graphicSettingConfig.Equals(tmpGraphicSetting))
        {
            UIManager.singleton.ShowCommonPopUpTextPanel(
                ...
                LocalizationManager.singleton.GetLocalization("SYS_ConfirmApplySetting"),
