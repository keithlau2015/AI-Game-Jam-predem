...
public class ControlPrefSettingPanel : CommonPopUpPanel
{
    ...
    public override void Show()
    {
        ...
        moveForward.onClick.AddListener(() => {
            moveFowardKeyCode.text = LocalizationController.singleton.GetLabel("SYS_WaitingPressKeyCode");
        ...
        moveBackward.onClick.AddListener(() => {
            moveBackwardKeyCode.text = LocalizationController.singleton.GetLabel("SYS_WaitingPressKeyCode");
        ...
        moveLeft.onClick.AddListener(() => {
            moveLeftKeyCode.text = LocalizationController.singleton.GetLabel("SYS_WaitingPressKeyCode");
        ...
        moveRight.onClick.AddListener(() => {
            moveRightKeyCode.text = LocalizationController.singleton.GetLabel("SYS_WaitingPressKeyCode");
        ...
        interaction.onClick.AddListener(() => {
            interactionKeyCode.text = LocalizationController.singleton.GetLabel("SYS_WaitingPressKeyCode");
